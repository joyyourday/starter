...
function DownloadM2M2({ movie }) {
  ...
  const ldJsonData = JSON.stringify({
    ...
    "potentialAction": {
      ...
      "target": [
        {
          "@type": "EntryPoint",
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/MurderMystery2-2023/Murder2Mystery"
        },
        {
          "@type": "EntryPoint",
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/MurderMystery2-2023/M2MSR1"
        }
      ]
    },
    "aggregateRating": {
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Murder Mystery 2 (2023) Full Movie Online Free | Movie MX Player™</title>
