...
function Roached({ movie }) {
      ...
      "target": [
        {
          "@type": "EntryPoint",
          "name": "Roached (2023)",
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/Roached-2023/Roached"
        },
        {
          "@type": "EntryPoint",
          "name": "Roached (2023)",
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/Roached-2023/RAHSR1"
        }
      ]
    },
    "aggregateRating": {
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Roached (2023) Full Movie Online Free | Movie MX Player™</title>
