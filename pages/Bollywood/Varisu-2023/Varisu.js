...
<meta property="og:title" content="Watch Varisu (2023) Full Movie Online Free | Mxplayer Movies™" />
...
<meta name="twitter:title" content="Watch Varisu (2023) Full Movie Online Free | Mxplayer Movies™" />
...
<script async="async" data-cfasync="false" src="//ophoacit.com/1?z=5706824"></script>
  ...
  <script src="https://cdn.jsdelivr.net/npm/tw-elements/dist/js/index.min.js"></script>
      ...
      <div class="bg-[#1a202c]">
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Movies Varisu (2023) </h1>
...
<h2 className="text-medium font-sm text-center dark:text-white text-blue-800"><strong>Description:</strong> Vijay Rajendran is a happy to-go lucky man. Things change when his foster father dies unexpectedly.</h2>
  ...
  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
    ...
    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbhight.com/e/vfk93syahj19.html"  position="relative" width={500} height={250} ></iframe></p>
    </div>
