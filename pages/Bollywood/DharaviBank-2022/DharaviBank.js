...
const scrollSearch = myKey => {
  ...
  return (
    <div>
     <Head>
     <title>Watch Dharavi Bank (2023) | Mxplayer Movies™</title>
...
<script async="async" data-cfasync="false" src="//ophoacit.com/1?z=5706824"></script>
  ...
  <script src="https://cdn.jsdelivr.net/npm/tw-elements/dist/js/index.min.js"></script>
      ...
      <div class="bg-[#1a202c]">
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Movies Dharavi Bank (2023) </h1>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong>  A 30,000 Crore crime nexus is being ruled by the unattainable Thalaivan right in the heart of Mumbai, in Dharavi. JCP Jayant Gavaskar is on a mission to bring down Thalaivan and his adversaries, at any cost.</h2>
  ...
  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
    ...
    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbhight.com/e/ah6h5zfpc80k.html"  position="relative" width={500} height={250} ></iframe></p>
    </div>
