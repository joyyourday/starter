...
function FRZSR1({ movie }) {
  ...
  const ldJsonData = JSON.stringify({
    ...
    "potentialAction": {
      ...
      "target": [
        {
          "@type": "EntryPoint",
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/Faraaz-2022/Faraaz"
        },
        {
          "@type": "EntryPoint",
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/Faraaz-2022/FRZSR1"
        }
      ]
    },
    "aggregateRating": {
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Faraaz (2023) Full Movie Online Free | Movie MX Player™</title>
