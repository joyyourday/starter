...
function DownloadTNA1({ movie }) {
      ...
      "target": [
        {
          ...
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/TheNightAgent-2023/TheNightAgent"
        },
        {
          "@type": "EntryPoint",
          "name": "The Night Agent (2023)",
          "urlTemplate": "https://moviemxplayer.netlify.app/Bollywood/TheNightAgent-2023/TNASR1"
        }
      ]
    },
    "aggregateRating": {
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch The Night Agent (2023) Full Movie Online Free | Movie MX Player™</title>
