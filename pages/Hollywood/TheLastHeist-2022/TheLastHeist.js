...
<script async="async" data-cfasync="false" src="//ophoacit.com/1?z=5706824"></script>
  ...
  <script src="https://cdn.jsdelivr.net/npm/tw-elements/dist/js/index.min.js"></script>
      ...
      <div class="bg-[#1a202c]">
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Movies The Last Heist (2022) </h1>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> The four thieves bounded by honor meet back at the local boozer, the place where it all began. Beneath the banter lies a dark secret that test the loyalty of these four friends to the limit to see if there really is honor among thieves.</h2>
  ...
  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
    ...
    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbhight.com/e/itlzb0vkyqdv.html"  position="relative" width={500} height={250} ></iframe></p>
    </div>
