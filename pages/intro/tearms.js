...
const Tearms = () => {
  return (
    <div>
        <Head>
        <title>Movie Mx Player™ Terms of Service</title>
      
	<meta name="description" content="Watch
 now the Best TV shows and Movies " />
	<meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
	<meta name="keywords" content="Movie Mx Player,streaming,latest movies,online tv,latest free movies,watch latest movies online,latest full movies online" />
...
<meta name="revisit-after" content="1 days" />
  <meta name="robots" content="index, follow" />
	...
	<meta name="twitter:title" content="Movie Mx Player™ " />
  ...
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">Using Movie Mx Player</p>
      <p className="text-gray-500 mb-6">
      When you enter Movie Mx Player you automatically agree to all our rules and regulations!
      </p>
      <p className="font-bold mb-2">Hosting and Legal Issues</p>
      <p className="text-gray-500 mb-6">
      Movie Mx Player is not hosting or uploading any copyrighted content or media of any kind, we only store links to third-party websites that carry their own legal responsibility for their content. If you want to remove content from these websites, please contact these media hosts directly.
      Movie Mx Player is working according to DMCA, so if you need to remove any content from the website, you can contact us @ <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer@gmail.com">drtrailer2022@gmail.com</a>.
      </p>
      <p className="font-bold mb-2">
      Responsibilities.
      </p>
      <p className="text-gray-500 mb-6">
      Movie Mx Player is not responsible for anything that might happen on third-party websites. We are not responsible for the accuracy, compliance, copyright, legality, decency, or any other aspect of the content of other linked sites. Please, be careful when you install, download or submit any personal or CC information!
      </p>

     
      <p className="text-gray-500">
      Movie Mx Player holds no responsibility for any legal or copyright issues that may occur due to the use of Movie Mx Playermovie. Please check local copyright laws or the rules of your provider to avoid legal problems.
      </p>
    </div>
