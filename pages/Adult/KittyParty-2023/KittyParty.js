...
function KittyParty({ movie }) {
      ...
      "target": [
        {
          ...
          "urlTemplate": "https://moviemxplayer.netlify.app/Adult/KittyParty-2023/KittyParty"
        },
        {
          "@type": "EntryPoint",
          "name": "Kitty Party Ullu Web Series (2023)",
          "urlTemplate": "https://moviemxplayer.netlify.app/Adult/KittyParty-2023/KTPSR1"
        },
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Kitty Party (2023) Full Movie Online Free | Movie MX Player™</title>
...
<meta property="og:title" content="Watch Kitty Party (2023) | Movie MX Player™" />
